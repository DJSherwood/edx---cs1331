...
public class StringOperations {
    public static void main(String[] args) {
        ...
        // a) create string and print
        String usrName = "Daniel";
        System.out.println(usrName);
        // b) replace first and last letters
        String newName = 'A' + usrName.substring(1,5) + 'Z';
        System.out.println(newName);
        // c) work with urls
        String url = "www.youtube.com";
        System.out.println(url);
        // d) just print out that name section
        System.out.println(url.substring(4, url.length() - 4) + "1331");
